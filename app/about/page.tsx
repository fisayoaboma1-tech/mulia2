    ...
    <main className="min-h-screen bg-background pt-15">
      ...
      <section className="py-24 lg:py-32 bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-primary-foreground/90 leading-relaxed">
            <p className="text-lg">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-medium text-foreground text-balance mb-8">
                Our Story
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            <div className="border-t border-primary-foreground/20 pt-8">
              <h3 className="font-serif text-2xl font-medium text-primary-foreground mb-4">Quality First</h3>
            ...
            <div className="border-t border-primary-foreground/20 pt-8">
              <h3 className="font-serif text-2xl font-medium text-primary-foreground mb-4">Sustainable Sourcing</h3>
              <p className="text-primary-foreground/70 leading-relaxed">
            ...
            <div className="border-t border-primary-foreground/20 pt-8">
              <h3 className="font-serif text-2xl font-medium text-primary-foreground mb-4">Global Reach</h3>
              <p className="text-primary-foreground/70 leading-relaxed">
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <Button
            size="lg"
            asChild
            className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-10 py-7 text-lg group"
          >
            <Link href="/contact">
              Get in touch
