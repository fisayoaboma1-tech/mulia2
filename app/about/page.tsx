    ...
    <main className="min-h-screen bg-background pt-15">
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-primary-foreground text-balance mb-6 sm:mb-8">
            Ready to work with us?
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-primary-foreground/80 leading-relaxed mb-8 sm:mb-10">
